...
const allAnimalsInEuropeWeighLessThanOnehundred = animals
  .filter((animal) => animal.continents.filter((a) => a === "Europe"))
  .every((b) => b.weight < 100);
...
//   });
// console.log(test);
//console.log("testreduce ", weightOfAllAnimalsInAfrica);
// const test = animals.filter((animal) => {
//   return animal.continents.includes("Africa");
// });
// console.log(test);
